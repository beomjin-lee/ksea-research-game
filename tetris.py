...
class Game:
	...
	def row_cleared(self):
	    #board = self.board_class.board.copy()
	    point = self.score - self.prev_score

	    if point == 0:
	    	return 0
	    elif point == self.add_score(1):
	    	return 1
	    elif point == self.add_score(2):
	    	return 2
	    elif point == self.add_score(3):
	    	return 3
	    elif point == self.add_score(4):
	    	return 4
